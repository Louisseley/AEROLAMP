...
const SignorLogin = () => {
   ...
   return (
      <div className="bg1 w-[100%] h-[100vh] flex flex-col items-center justify-center font-inknut font-normal md:flex-row">
         ...
         <button onClick={() => {navigate('/register')}} className="bg-[#3C619A] button cursor-pointer color text-[24px] w-[250px] py-[8px] round  mt-[5%] button-intro transition duration-300 ease-in-out">Sign Up</button>
         <p className="text-[16px] my-[1%] text">Or</p>
         <button onClick={() => {navigate('/login')}} className="bg-[#3C619A] button color text-[24px] cursor-pointer w-[250px] py-[8px] round button-intro transition duration-300 ease-in-out">Log In</button>
