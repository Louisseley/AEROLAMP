...
<nav className="transparent fixed w-full top-[20px] left-0 z-70">
   ...
   >
      ...
      <img
         className="w-[40px] h-[20px] border-white cursor-pointer nav-drawer"
   ...
   {isModalOpen && (
      <div onClick={toggleModal} className="modal relative w-[400px] h-full flex flex-col z-10 shadow-lg transition-transform transform ease-in-out duration-800">
         <div onClick={() => {navigate("/home"), toggleModal()}} className="w-auto mt-[30px]">
            <h1
               className="border1 font-inknut text-[24px] font-normal h-[30px] w-[100%] pl-[20px] py-[5px] cursor-pointer nav"
            >
               Home
            </h1>
         </div>
         <div onClick={() => {navigate("/aerolamp"), toggleModal()}} className="w-[100%] flex flex-row justify-between items-center border2 nav">
            <h1 className="font-inknut text-[24px] font-normal h-[30px] w-[100%] pl-[20px] py-[5px] cursor-pointer">
               Aerolamp
            </h1>
         </div>
         <div onClick={() => {navigate("/about"), toggleModal()}} className="w-[100%] flex flex-row justify-between items-center border2 nav">
            <h1 className="font-inknut text-[24px] font-normal h-[30px] w-[100%] pl-[20px] py-[5px] cursor-pointer">
               About
            </h1>
         </div>
         <div className="w-[100%]">
            <h1
               ...
               className="border2 font-inknut text-[24px] font-normal h-[30px] w-[100%] pl-[20px] py-[5px] cursor-pointer nav"
            >
               Users
            </h1>
         </div>
